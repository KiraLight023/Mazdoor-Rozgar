          ...
          <Grid container item alignItems="center">
            ...
            <Grid item container direction="row" xs={9}>
              ...
              >
                ...
                <Grid item>
                  <label for="नौकरी का नाम">
                    <Typography>नौकरी का नाम</Typography>
                  </label>
                </Grid>
                <Grid item>
                  <IconButton
              ...
              >
                ...
                <Grid item>
                  <label for="शामिल होने की तिथि">
                    <Typography>शामिल होने की तिथि</Typography>
                  </label>
                </Grid>
                <Grid item>
                  <IconButton
...
const AcceptedApplicants = (props) => {
  ...
  return (
    <>
      ...
      >
        <Grid item>
          <Typography variant="h2" style={{color:"white",fontWeight:"bold"}}>कर्मचारी</Typography>
        </Grid>
        <Grid item>
